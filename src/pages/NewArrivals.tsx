              ...
              >
                ...
                <div className="text-center">
                  ...
                  <button 
                    ...
                    className="w-full bg-black text-white py-3 text-xs font-medium tracking-widest uppercase hover:bg-leather-brown transition-all duration-300 flex items-center justify-center gap-2"
                  >
